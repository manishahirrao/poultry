...
export interface MotionTokens {
  ...
  enter: string;
  elaborate: string;
  springSnappy: { type: string; stiffness: number; damping: number };
  springSmooth: { type: string; stiffness: number; damping: number };
  springHeavy: { type: string; stiffness: number; damping: number };
}
