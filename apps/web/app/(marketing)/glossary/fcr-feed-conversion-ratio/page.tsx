// FlockIQ — FCR Glossary Page
// File: apps/web/app/(marketing)/glossary/fcr-feed-conversion-ratio/page.tsx
...
export const metadata: Metadata = {
  title: 'What is FCR (Feed Conversion Ratio)? — Poultry Farming Explained',
  description: 'FCR measures how much feed is needed to produce 1 kg of chicken meat. Lower FCR = more profit. Learn calculation, industry standards, and improvement tips.',
  keywords: ['FCR meaning', 'feed conversion ratio', 'poultry FCR', 'FCR calculation', 'FCR in Hindi'],
  openGraph: {
    title: 'What is FCR (Feed Conversion Ratio)?',
    description: 'Understand FCR in poultry farming - calculation, standards, and how to improve it.',
    url: 'https://FlockIQ.ai/glossary/fcr-feed-conversion-ratio',
  },
  alternates: {
    canonical: 'https://FlockIQ.ai/glossary/fcr-feed-conversion-ratio',
  },
};

export default function FCRPage() {
  const terms = glossaryData.terms;
  const term = terms.find((t: any) => t.slug === 'fcr-feed-conversion-ratio');
          ...
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm">
              ...
              <p className="text-neutral600">
                Example: If your flock consumes 50,000 kg of feed and gains 25,000 kg of weight, your FCR is 2.0.
              </p>
            </div>
          </div>
        </section>
      ...
      <section className="py-16 bg-brandGreen700 text-white">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <h2 className="text-3xl font-bold mb-4">
            Track FCR with FlockIQ
          </h2>
          <p className="text-xl text-white/90 mb-8">
            Our platform helps you monitor feed costs and optimize FCR for better profitability.
          </p>
          <Link
            href="/signup"
