// FlockIQ — Glossary Term Page: Poultry Price Prediction
// File: apps/web/app/(marketing)/glossary/poultry-price-prediction/page.tsx
...
export const metadata: Metadata = {
  title: 'Poultry Price Prediction — Poultry Farming Glossary',
  description: 'Poultry price prediction is the use of AI and machine learning to forecast future broiler chicken prices. Learn how AI achieves 95%+ accuracy.',
  keywords: ['poultry price prediction AI', 'broiler price forecasting', 'machine learning poultry', 'AI price intelligence'],
  openGraph: {
    title: 'Poultry Price Prediction — Poultry Farming Glossary',
    description: 'Understand AI-powered poultry price prediction for commercial farmers.',
    url: 'https://FlockIQ.ai/glossary/poultry-price-prediction',
  },
  alternates: {
    canonical: 'https://FlockIQ.ai/glossary/poultry-price-prediction',
  },
};

export default function PoultryPricePredictionPage() {
  const term = glossaryData.terms.find((t: any) => t.slug === 'poultry-price-prediction');
      ...
      <section className="py-16 bg-brandGreen700 text-white">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <h2 className="text-3xl font-bold mb-4">
            Get AI Price Predictions for Your Farm
          </h2>
          <p className="text-xl text-white/90 mb-8">
            Join 200+ farmers using FlockIQ for data-driven selling decisions.
          </p>
          <Link
            href="/signup"
