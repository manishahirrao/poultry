// FlockIQ — HPAI Glossary Page
// File: apps/web/app/(marketing)/glossary/hpai-bird-flu/page.tsx
...
export const metadata: Metadata = {
  title: 'What is HPAI (Bird Flu)? — Poultry Farming Explained',
  description: 'HPAI (bird flu) is a deadly viral disease that can wipe out entire flocks. Early warning is critical. Learn symptoms, prevention, and impact.',
  keywords: ['HPAI meaning', 'bird flu poultry', 'HPAI in Hindi', 'avian influenza', 'poultry disease'],
  openGraph: {
    title: 'What is HPAI (Bird Flu)?',
    description: 'Understand HPAI in poultry farming - symptoms, prevention, and early warning importance.',
    url: 'https://FlockIQ.ai/glossary/hpai-bird-flu',
  },
  alternates: {
    canonical: 'https://FlockIQ.ai/glossary/hpai-bird-flu',
  },
};

export default function HPAIPage() {
  const terms = glossaryData.terms;
  const term = terms.find((t: any) => t.slug === 'hpai-bird-flu');
          ...
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm">
              <ul className="grid md:grid-cols-2 gap-4">
                {term.symptoms.map((symptom: string, index: number) => (
                  <li key={index} className="flex items-center gap-3">
                    <span className="text-red600 text-xl">⚠</span>
                    <span className="text-neutral700">{symptom}</span>
                  </li>
                ))}
              </ul>
            </div>
          ...
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <div className="bg-brandGreen50 rounded-xl p-8 border border-brandGreen200">
              <ul className="space-y-3">
                {term.prevention.map((measure: string, index: number) => (
      ...
      <section className="py-16 bg-brandGreen700 text-white">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <h2 className="text-3xl font-bold mb-4">
            Get HPAI Early Warnings with FlockIQ
          </h2>
          <p className="text-xl text-white/90 mb-8">
            Our platform provides 48-hour early warnings for HPAI outbreaks to help you protect your flock.
          </p>
          <Link
            href="/signup"
