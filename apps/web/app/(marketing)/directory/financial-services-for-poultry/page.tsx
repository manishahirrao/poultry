// FlockIQ — Financial Services Directory Page
// File: apps/web/app/(marketing)/directory/financial-services-for-poultry/page.tsx
...
export const metadata: Metadata = {
  title: 'Best Financial Services for Poultry Farmers — 2026 Directory',
  description: 'Discover the best financial services for poultry farmers: bank loans, KCC, poultry insurance, working capital. Compare interest rates, eligibility, and terms.',
  keywords: ['poultry farm loans', 'poultry financing', 'KCC for poultry', 'poultry insurance India'],
  openGraph: {
    title: 'Best Financial Services for Poultry Farmers',
    description: 'Directory of financial services for poultry farmers in India.',
    url: 'https://FlockIQ.ai/directory/financial-services-for-poultry',
  },
  alternates: {
    canonical: 'https://FlockIQ.ai/directory/financial-services-for-poultry',
  },
};

export default function FinancialServicesPage() {
  const categories = directoryData.categories;
  const category = categories.find((c: any) => c.slug === 'financial-services-for-poultry');
      ...
      <section className="py-16 bg-brandGreen700 text-white">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <h2 className="text-3xl font-bold mb-4">
            Improve Cash Flow with Better Sell Timing
          </h2>
          <p className="text-xl text-white/90 mb-8">
            FlockIQ helps you sell at the right price, improving cash flow and making loan repayment easier.
          </p>
          <Link
            href="/signup"
