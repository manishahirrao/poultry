// FlockIQ — Equipment & Infrastructure Directory Page
// File: apps/web/app/(marketing)/directory/equipment-infrastructure/page.tsx
...
export const metadata: Metadata = {
  title: 'Best Equipment & Infrastructure for Poultry Farms — 2026 Directory',
  description: 'Discover the best poultry farm equipment: feeders, drinkers, climate control, cages, sheds. Compare features, pricing, and suppliers.',
  keywords: ['poultry farm equipment', 'broiler shed equipment', 'poultry climate control', 'poultry feeders drinkers'],
  openGraph: {
    title: 'Best Equipment & Infrastructure for Poultry Farms',
    description: 'Directory of equipment and infrastructure for poultry farms in India.',
    url: 'https://FlockIQ.ai/directory/equipment-infrastructure',
  },
  alternates: {
    canonical: 'https://FlockIQ.ai/directory/equipment-infrastructure',
  },
};

export default function EquipmentInfrastructurePage() {
  const categories = directoryData.categories;
  const category = categories.find((c: any) => c.slug === 'equipment-infrastructure');
      ...
      <section className="py-16 bg-brandGreen700 text-white">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-xl text-white/90 mb-8">
            Use FlockIQ to understand price patterns and time equipment purchases strategically.
          </p>
          <Link
            href="/signup"
