// FlockIQ — Farm Management Software Directory Page
// File: apps/web/app/(marketing)/directory/farm-management-software/page.tsx
...
export const metadata: Metadata = {
  title: 'Best Farm Management Software for Poultry Farmers — 2026 Directory',
  description: 'Discover the best poultry farm management software: FlockIQ, Broiler Manager, FarmERP. Compare features, pricing, and integrations.',
  keywords: ['poultry farm management software', 'broiler farm software', 'best farm management app', 'poultry ERP'],
  openGraph: {
    title: 'Best Farm Management Software for Poultry Farmers',
    description: 'Directory of farm management software for poultry farmers in India.',
    url: 'https://FlockIQ.ai/directory/farm-management-software',
  },
  alternates: {
    canonical: 'https://FlockIQ.ai/directory/farm-management-software',
  },
};

export default function FarmManagementSoftwarePage() {
  const categories = directoryData.categories;
  const category = categories.find((c: any) => c.slug === 'farm-management-software');
      ...
      <section className="py-16 bg-brandGreen700 text-white">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <h2 className="text-3xl font-bold mb-4">
            Choose the Best Farm Management Software
          </h2>
          <p className="text-xl text-white/90 mb-8">
            For commercial farmers (10,000+ birds), FlockIQ provides the best combination of price intelligence, Hindi support, and daily delivery.
          </p>
          <Link
            href="/signup"
