// FlockIQ — Price Intelligence Tools Directory Page
// File: apps/web/app/(marketing)/directory/price-intelligence-tools/page.tsx
...
export const metadata: Metadata = {
  title: 'Best Price Intelligence Tools for Poultry Farmers — 2026 Directory',
  description: 'Discover the best poultry price intelligence tools: FlockIQ, AGMARKNET, NECC reports. Compare features, pricing, and accuracy.',
  keywords: ['poultry price intelligence tools', 'price forecasting software', 'best poultry price app', 'AGMARKNET vs FlockIQ'],
  openGraph: {
    title: 'Best Price Intelligence Tools for Poultry Farmers',
    description: 'Directory of price intelligence tools for poultry farmers in India.',
    url: 'https://FlockIQ.ai/directory/price-intelligence-tools',
  },
  alternates: {
    canonical: 'https://FlockIQ.ai/directory/price-intelligence-tools',
  },
};

export default function PriceIntelligenceToolsPage() {
  const categories = directoryData.categories;
  const category = categories.find((c: any) => c.slug === 'price-intelligence-tools');
      ...
      <section className="py-16 bg-brandGreen700 text-white">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <h2 className="text-3xl font-bold mb-4">
            Choose the Best Price Intelligence Tool
          </h2>
          <p className="text-xl text-white/90 mb-8">
            For commercial farmers (10,000+ birds), FlockIQ provides the best combination of accuracy, language support, and daily delivery.
          </p>
