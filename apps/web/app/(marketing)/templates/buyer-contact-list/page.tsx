// FlockIQ — Buyer Contact List Template Page
// File: apps/web/app/(marketing)/templates/buyer-contact-list/page.tsx
...
export const metadata: Metadata = {
  title: 'Buyer Contact List Template — Free Download for Poultry Farmers',
  description: 'Download free buyer contact list Excel template. Maintain a list of potential buyers with their contact details and price preferences.',
  keywords: ['buyer contact list template', 'poultry buyer Excel', 'buyer database template', 'farm buyer management'],
  openGraph: {
    title: 'Buyer Contact List Template — Free Download',
    description: 'Free Excel template for maintaining buyer contact list in poultry farms.',
    url: 'https://FlockIQ.ai/templates/buyer-contact-list',
  },
  alternates: {
    canonical: 'https://FlockIQ.ai/templates/buyer-contact-list',
  },
};

export default function BuyerContactListPage() {
  const templates = templatesData.templates;
  const template = templates.find((t: any) => t.slug === 'buyer-contact-list');
      ...
      <section className="py-16 bg-brandGreen700 text-white">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <h2 className="text-3xl font-bold mb-4">
            Negotiate Better with FlockIQ
          </h2>
          <p className="text-xl text-white/90 mb-8">
            Use FlockIQ price forecasts to negotiate better with buyers. Know the fair price before calling.
          </p>
          <Link
            href="/signup"
