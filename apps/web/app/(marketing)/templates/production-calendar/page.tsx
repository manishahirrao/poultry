// FlockIQ — Production Calendar Template Page
// File: apps/web/app/(marketing)/templates/production-calendar/page.tsx
...
export const metadata: Metadata = {
  title: '12-Month Production Calendar Template — Free Download for Poultry Farmers',
  description: 'Download free 12-month production calendar Excel template. Plan your entire year\'s production schedule to optimize for seasonal price patterns.',
  keywords: ['production calendar template', 'poultry production planning', 'farm scheduling Excel', 'seasonal price planning'],
  openGraph: {
    title: '12-Month Production Calendar Template — Free Download',
    description: 'Free Excel template for planning annual production schedule in poultry farms.',
    url: 'https://FlockIQ.ai/templates/production-calendar',
  },
  alternates: {
    canonical: 'https://FlockIQ.ai/templates/production-calendar',
  },
};

export default function ProductionCalendarPage() {
  const templates = templatesData.templates;
  const template = templates.find((t: any) => t.slug === 'production-calendar');
      ...
      <section className="py-16 bg-brandGreen700 text-white">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <h2 className="text-3xl font-bold mb-4">
            Validate Your Calendar with FlockIQ
          </h2>
          <p className="text-xl text-white/90 mb-8">
            Use FlockIQ 7-day forecasts to validate and adjust your production calendar monthly.
          </p>
          <Link
            href="/signup"
