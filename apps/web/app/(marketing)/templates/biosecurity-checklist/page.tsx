// FlockIQ — Biosecurity Checklist Template Page
// File: apps/web/app/(marketing)/templates/biosecurity-checklist/page.tsx
...
export const metadata: Metadata = {
  title: 'Biosecurity Checklist Template — Free Download for Poultry Farmers',
  description: 'Download free biosecurity checklist PDF template. Daily checklist to ensure biosecurity measures and prevent disease outbreaks.',
  keywords: ['biosecurity checklist', 'poultry biosecurity PDF', 'disease prevention checklist', 'farm biosecurity template'],
  openGraph: {
    title: 'Biosecurity Checklist Template — Free Download',
    description: 'Free PDF template for daily biosecurity checklist in poultry farms.',
    url: 'https://FlockIQ.ai/templates/biosecurity-checklist',
  },
  alternates: {
    canonical: 'https://FlockIQ.ai/templates/biosecurity-checklist',
  },
};

export default function BiosecurityChecklistPage() {
  const templates = templatesData.templates;
  const template = templates.find((t: any) => t.slug === 'biosecurity-checklist');
      ...
      <section className="py-16 bg-brandGreen700 text-white">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <h2 className="text-3xl font-bold mb-4">
            Get HPAI Alerts with FlockIQ
          </h2>
          <p className="text-xl text-white/90 mb-8">
            HPAI alerts from FlockIQ highlight when biosecurity is most critical. Use this checklist to stay prepared.
          </p>
          <Link
            href="/signup"
