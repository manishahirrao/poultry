// FlockIQ — Vaccination Schedule Template Page
// File: apps/web/app/(marketing)/templates/vaccination-schedule/page.tsx
...
export const metadata: Metadata = {
  title: 'Vaccination Schedule Template — Free Download for Poultry Farmers',
  description: 'Download free vaccination schedule Excel template. Track vaccination schedule for each batch to ensure all vaccines are administered on time.',
  keywords: ['vaccination schedule template', 'poultry vaccination Excel', 'vaccine tracking template', 'farm vaccination record'],
  openGraph: {
    title: 'Vaccination Schedule Template — Free Download',
    description: 'Free Excel template for tracking vaccination schedule in poultry farms.',
    url: 'https://FlockIQ.ai/templates/vaccination-schedule',
  },
  alternates: {
    canonical: 'https://FlockIQ.ai/templates/vaccination-schedule',
  },
};

export default function VaccinationSchedulePage() {
  const templates = templatesData.templates;
  const template = templates.find((t: any) => t.slug === 'vaccination-schedule');
      ...
      <section className="py-16 bg-brandGreen700 text-white">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <h2 className="text-3xl font-bold mb-4">
            Get Disease Alerts with FlockIQ
          </h2>
          <p className="text-xl text-white/90 mb-8">
            Disease alerts from FlockIQ help you prioritize vaccination timing. Use this schedule to stay compliant.
          </p>
          <Link
            href="/signup"
