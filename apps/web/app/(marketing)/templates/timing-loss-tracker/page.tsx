// FlockIQ — Timing Loss Tracker Template Page
// File: apps/web/app/(marketing)/templates/timing-loss-tracker/page.tsx
...
export const metadata: Metadata = {
  title: 'Timing Loss Tracker Template — Free Download for Poultry Farmers',
  description: 'Download free timing loss tracker Excel template. Track timing decisions and their outcomes to measure the impact of sell timing on profit.',
  keywords: ['timing loss tracker', 'sell timing Excel', 'timing loss calculator', 'poultry sell timing'],
  openGraph: {
    title: 'Timing Loss Tracker Template — Free Download',
    description: 'Free Excel template for tracking timing loss in poultry farms.',
    url: 'https://FlockIQ.ai/templates/timing-loss-tracker',
  },
  alternates: {
    canonical: 'https://FlockIQ.ai/templates/timing-loss-tracker',
  },
};

export default function TimingLossTrackerPage() {
  const templates = templatesData.templates;
  const template = templates.find((t: any) => t.slug === 'timing-loss-tracker');
      ...
      <section className="py-16 bg-brandGreen700 text-white">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <h2 className="text-3xl font-bold mb-4">
            Prove ROI with FlockIQ
          </h2>
          <p className="text-xl text-white/90 mb-8">
            FlockIQ provides optimal sell dates. Use this tracker to measure actual vs optimal and prove ROI.
          </p>
          <Link
            href="/signup"
