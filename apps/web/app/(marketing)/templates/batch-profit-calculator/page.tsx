// FlockIQ — Batch Profit Calculator Template Page
// File: apps/web/app/(marketing)/templates/batch-profit-calculator/page.tsx
...
export const metadata: Metadata = {
  title: 'Batch Profit Calculator Template — Free Download for Poultry Farmers',
  description: 'Download free batch profit calculator Excel template. Calculate profit/loss for each batch to identify profitable practices.',
  keywords: ['batch profit calculator', 'poultry profit template', 'batch ROI calculator', 'farm profitability Excel'],
  openGraph: {
    title: 'Batch Profit Calculator Template — Free Download',
    description: 'Free Excel template for calculating batch profit in poultry farms.',
    url: 'https://FlockIQ.ai/templates/batch-profit-calculator',
  },
  alternates: {
    canonical: 'https://FlockIQ.ai/templates/batch-profit-calculator',
  },
};

export default function BatchProfitCalculatorPage() {
  const templates = templatesData.templates;
  const template = templates.find((t: any) => t.slug === 'batch-profit-calculator');
      ...
      <section className="py-16 bg-brandGreen700 text-white">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <h2 className="text-3xl font-bold mb-4">
            Maximize Batch Profit with FlockIQ
          </h2>
          <p className="text-xl text-white/90 mb-8">
            Our platform provides sell signals to optimize selling price. Use this calculator to measure the impact.
          </p>
          <Link
            href="/signup"
