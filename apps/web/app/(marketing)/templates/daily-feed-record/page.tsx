// FlockIQ — Daily Feed Record Template Page
// File: apps/web/app/(marketing)/templates/daily-feed-record/page.tsx
...
export const metadata: Metadata = {
  title: 'Daily Feed Record Template — Free Download for Poultry Farmers',
  description: 'Download free daily feed record Excel template. Track feed consumption per shed, monitor FCR, and identify issues early.',
  keywords: ['daily feed record template', 'feed tracking template', 'poultry feed Excel template', 'FCR tracking'],
  openGraph: {
    title: 'Daily Feed Record Template — Free Download',
    description: 'Free Excel template for tracking daily feed consumption in poultry farms.',
    url: 'https://FlockIQ.ai/templates/daily-feed-record',
  },
  alternates: {
    canonical: 'https://FlockIQ.ai/templates/daily-feed-record',
  },
};

export default function DailyFeedRecordPage() {
  const templates = templatesData.templates;
  const template = templates.find((t: any) => t.slug === 'daily-feed-record');
      ...
      <section className="py-16 bg-brandGreen700 text-white">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <h2 className="text-3xl font-bold mb-4">
            Automate Feed Tracking with FlockIQ
          </h2>
          <p className="text-xl text-white/90 mb-8">
            Templates are great, but our platform automates tracking and provides AI-powered insights.
          </p>
          <Link
            href="/signup"
