// FlockIQ — Weekly Farm Checklist Template Page
// File: apps/web/app/(marketing)/templates/weekly-farm-checklist/page.tsx
...
export const metadata: Metadata = {
  title: 'Weekly Farm Checklist Template — Free Download for Poultry Farmers',
  description: 'Download free weekly farm checklist PDF template. Comprehensive weekly checklist to ensure all farm operations are running smoothly.',
  keywords: ['weekly farm checklist', 'poultry farm management PDF', 'farm operations checklist', 'weekly farm review'],
  openGraph: {
    title: 'Weekly Farm Checklist Template — Free Download',
    description: 'Free PDF template for weekly farm checklist in poultry farms.',
    url: 'https://FlockIQ.ai/templates/weekly-farm-checklist',
  },
  alternates: {
    canonical: 'https://FlockIQ.ai/templates/weekly-farm-checklist',
  },
};

export default function WeeklyFarmChecklistPage() {
  const templates = templatesData.templates;
  const template = templates.find((t: any) => t.slug === 'weekly-farm-checklist');
      ...
      <section className="py-16 bg-brandGreen700 text-white">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <h2 className="text-3xl font-bold mb-4">
            Review FlockIQ Accuracy Weekly
          </h2>
          <p className="text-xl text-white/90 mb-8">
            Review FlockIQ accuracy and signal performance in weekly check. Adjust farm practices based on insights.
          </p>
          <Link
            href="/signup"
