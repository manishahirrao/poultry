// FlockIQ — Expense Tracker Template Page
// File: apps/web/app/(marketing)/templates/expense-tracker/page.tsx
...
export const metadata: Metadata = {
  title: 'Expense Tracker Template — Free Download for Poultry Farmers',
  description: 'Download free expense tracker Excel template. Track all farm expenses by category to understand cost structure and identify savings.',
  keywords: ['expense tracker template', 'poultry expense Excel', 'farm cost tracking', 'expense management template'],
  openGraph: {
    title: 'Expense Tracker Template — Free Download',
    description: 'Free Excel template for tracking farm expenses in poultry farms.',
    url: 'https://FlockIQ.ai/templates/expense-tracker',
  },
  alternates: {
    canonical: 'https://FlockIQ.ai/templates/expense-tracker',
  },
};

export default function ExpenseTrackerPage() {
  const templates = templatesData.templates;
  const template = templates.find((t: any) => t.slug === 'expense-tracker');
      ...
      <section className="py-16 bg-brandGreen700 text-white">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <h2 className="text-3xl font-bold mb-4">
            Verify Feed Costs with FlockIQ
          </h2>
          <p className="text-xl text-white/90 mb-8">
            FlockIQ shows feed cost trends. Use expense tracker to verify actual costs and identify discrepancies.
          </p>
          <Link
            href="/signup"
