// FlockIQ — Manual Mandi Calling Comparison Page
// File: apps/web/app/(marketing)/comparisons/manual-mandi-calling/page.tsx
...
export const metadata: Metadata = {
  title: 'FlockIQ vs Manual Mandi Calling — Which is Better?',
  description: 'Compare FlockIQ with manual mandi calling. See why 7-day forecasts and 95% accuracy beat 30+ minutes daily calling.',
  keywords: ['FlockIQ vs manual calling', 'manual mandi calling', 'poultry price app comparison', 'calling traders for price'],
  openGraph: {
    title: 'FlockIQ vs Manual Mandi Calling',
    description: 'See why AI-powered price intelligence beats manual mandi calling for poultry farmers.',
    url: 'https://FlockIQ.ai/comparisons/manual-mandi-calling',
  },
  alternates: {
    canonical: 'https://FlockIQ.ai/comparisons/manual-mandi-calling',
  },
};

export default function ManualMandiCallingComparisonPage() {
  const comparisons = comparisonsData.comparisons;
  const comparison = comparisons.find((c: any) => c.slug === 'manual-mandi-calling');
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4 leading-tight">
              FlockIQ vs Manual Mandi Calling
            </h1>
            <p className="text-xl text-white/90 mb-6">
              See why AI-powered 7-day forecasts with 95% accuracy beat 30+ minutes daily calling traders.
            </p>
            <Link
              href="/signup"
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm">
              <h3 className="text-xl font-bold text-neutral700 mb-4">
                Stick with Manual Calling If:
              </h3>
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  <span className="text-neutral500">•</span>
                  <span className="text-neutral700">You have strong trader relationships</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-neutral500">•</span>
                  <span className="text-neutral700">Small farms (&lt; 5,000 birds)</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-neutral500">•</span>
                  <span className="text-neutral700">You prefer personal contact</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="bg-neutral50 rounded-xl p-8">
            <p className="text-neutral700 text-lg mb-4">
              "पहले मैं हर सुबह 2-3 व्यापारियों को कॉल करता था — कभी-कभी कोई उठाता नहीं था। 30 मिनट बर्बाद। अब FlockIQ सुबह 6:30 बजे WhatsApp पर भेज देता है। मैं बस देखता हूँ और बेच देता हूँ।"
            </p>
            <p className="text-neutral500 text-sm">
              — सुरेश कुमार पटेल, देवरिया (15,000 पक्षी)
            </p>
          </div>
        </div>
      </section>
