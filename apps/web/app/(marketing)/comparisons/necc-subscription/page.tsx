// FlockIQ — NECC Subscription Comparison Page
// File: apps/web/app/(marketing)/comparisons/necc-subscription/page.tsx
...
export const metadata: Metadata = {
  title: 'FlockIQ vs NECC Subscription — Which is Better?',
  description: 'Compare FlockIQ with NECC subscription. See why 7-day forecasts and daily signals beat weekly historical reports.',
  keywords: ['FlockIQ vs NECC', 'NECC subscription', 'poultry price app comparison', 'NECC weekly reports'],
  openGraph: {
    title: 'FlockIQ vs NECC Subscription',
    description: 'See why AI-powered price intelligence beats NECC weekly reports for poultry farmers.',
    url: 'https://FlockIQ.ai/comparisons/necc-subscription',
  },
  alternates: {
    canonical: 'https://FlockIQ.ai/comparisons/necc-subscription',
  },
};

export default function NECCSubscriptionComparisonPage() {
  const comparisons = comparisonsData.comparisons;
  const comparison = comparisons.find((c: any) => c.slug === 'necc-subscription');
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4 leading-tight">
              FlockIQ vs NECC Subscription
            </h1>
            <p className="text-xl text-white/90 mb-6">
              See why AI-powered 7-day forecasts with daily signals beat weekly historical reports.
            </p>
            <Link
              href="/signup"
            ...
            <table className="w-full border-collapse bg-white rounded-xl overflow-hidden shadow-sm">
              <thead>
                <tr className="bg-neutral50">
                  ...
                  <th className="text-center p-4 font-semibold text-neutral700 border-b">NECC Subscription</th>
                </tr>
              </thead>
              <tbody>
                <tr>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-neutral700">You are a large integrator</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-neutral500">•</span>
                  <span className="text-neutral700">You need historical research data</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-neutral500">•</span>
                  <span className="text-neutral700">You are a policy maker or researcher</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="bg-neutral50 rounded-xl p-8">
            <p className="text-neutral700 text-lg mb-4">
              "NECC रिपोर्ट अच्छी है लेकिन वह हफ्ते बाद आती है। तब तक बहुत देर हो चुकती है। FlockIQ हर रोज़ सुबह 6:30 बजे बता देता है कि आज बेचना है या रुकना है। यह बहुत बेहतर है।"
            </p>
            <p className="text-neutral500 text-sm">
              — विजय कुमार सिंह, आजमगढ़ (30,000 पक्षी)
            </p>
          </div>
        </div>
      </section>
